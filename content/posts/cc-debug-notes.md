...
> ![](/images/cc-debug-notes/20260423172545.png)
> ```python
...
> ```
> ![](/images/cc-debug-notes/20260423173439.png)
>
> **（5）循环退出条件**
...
>     return
> ```
> ![](/images/cc-debug-notes/20260423183231.png)
...
> ```
> ![](/images/cc-debug-notes/20260423190143.png)
> ![](/images/cc-debug-notes/20260423190428.png)
> ![](/images/cc-debug-notes/20260423190454.png)
...
> ```
> ![](/images/cc-debug-notes/20260423195045.png)
...
> ]})
> ```
> ![](/images/cc-debug-notes/20260423195756.png)
>
...
> ```
> render 效果：
> ![](/images/cc-debug-notes/20260423201145.png)
>
> 后续轮次正常 tool 调用，逐步更新 todo 状态。
>
> **Reminder 注入示例：**
> ![](/images/cc-debug-notes/20260423203531.png)
...
> })
> ```
> ![](/images/cc-debug-notes/20260423205642.png)
>
> 子 Agent loop 循环调用，将结果中所有 TextBlock 拼接后作为 `tool_result` 返回父 Agent：
> ![](/images/cc-debug-notes/20260423211958.png)
...
> - 相关代码：
> ![](/images/cc-debug-notes/20260424093415.png)
> 针对 `{"type": "tool_result", ...}` 进行处理：
> ![](/images/cc-debug-notes/20260424092735.png)
...
>
> Token 估算方式：
> ![](/images/cc-debug-notes/20260424095802.png)
>
> 超过预设值自动触发：
> ![](/images/cc-debug-notes/20260424095843.png)
>
> `auto_compact` 执行步骤：
...
>
> ![](/images/cc-debug-notes/20260424100109.png)
...
>
> ![](/images/cc-debug-notes/20260424100618.png)
...
>
> 调用 `task_create`：
> ![](/images/cc-debug-notes/20260424101917.png)
> ![](/images/cc-debug-notes/20260424101900.png)
>
> 工具输出结果：
> ```json
> {
...
> }
> ```
> ![](/images/cc-debug-notes/20260424102235.png)
> ![](/images/cc-debug-notes/20260424102304.png)
> ![](/images/cc-debug-notes/20260424102317.png)
...
> )
> ```
> ![](/images/cc-debug-notes/20260424102903.png)
> ![](/images/cc-debug-notes/20260424103103.png)
>
> JSON 文件内容：
> ![](/images/cc-debug-notes/20260424103129.png)
...
>
> 核心代码（`update` 方法内）：
> ![](/images/cc-debug-notes/20260424103507.png)
>
> 效果：
> ![](/images/cc-debug-notes/20260424103413.png)
...
> ![](/images/cc-debug-notes/20260424104758.png)
>
> | 数据结构 | 用途 |
> |----------|------|
...
> 4. 立即返回，不等任务结束
>
> ![](/images/cc-debug-notes/20260424104311.png)
>
> 执行完后，结果放入 notification 队列；`get_nowait()` 非阻塞取出（有元素立即拿，否则跳过）：
> ![](/images/cc-debug-notes/20260424105018.png)
>
> 通过 `BG.drain()` 取回后台内容：
> ![](/images/cc-debug-notes/20260424105034.png)
> ![](/images/cc-debug-notes/20260424104421.png)
...
>
> ![](/images/cc-debug-notes/20260424110527.png)
> ![](/images/cc-debug-notes/20260424110546.png)
...
>
> ![](/images/cc-debug-notes/20260424140858.png)
>
> ```python
...
>
> 工具调用：
> ![](/images/cc-debug-notes/20260424110905.png)
>
> `spawn` 实现逻辑：
> ![](/images/cc-debug-notes/20260424111918.png)
>
> 1. 检查 alice 是否已在团队中
...
>   })
>   ```
> ![](/images/cc-debug-notes/20260424113450.png)
> - `user`：工具返回结果
> - `assistant`：调用 `idle` 进入休眠
>
> 休眠实现：
> ![](/images/cc-debug-notes/20260424113030.png)
...
>
> ![](/images/cc-debug-notes/20260424114253.png)
>
> 持久化写入信箱：
> ![](/images/cc-debug-notes/20260424114311.png)
>
> 消息结构：
> ```python
> msg = {
...
> ![](/images/cc-debug-notes/20260424115004.png)
>
...
> ```
> ![](/images/cc-debug-notes/20260424124328.png)
> ![](/images/cc-debug-notes/20260424124400.png)
...
![](/images/cc-debug-notes/20260424134314.png)
...
> ```
> ![](/images/cc-debug-notes/20260424142002.png)
>
...
>   - agent-builder: ...
> ```
> ![](/images/cc-debug-notes/20260424142248.png)
> ![](/images/cc-debug-notes/20260424142310.png)
>
> **③ 运行时按需加载（Layer 2）**
...
> ```
> ![](/images/cc-debug-notes/20260424143745.png)
>
...
> ```
> ![](/images/cc-debug-notes/20260424143154.png)
>
> `load_skill` 返回：
> ```
...
> 调用 `spawn` 工具激活 alice：
> ![](/images/cc-debug-notes/20260424145315.png)
>
> 调用 `handle_shutdown_request`，消息投入信箱：
> ![](/images/cc-debug-notes/20260424145459.png)
>
> alice 取出消息，进入 shutdown 状态：
> ![](/images/cc-debug-notes/20260424145551.png)
> ![](/images/cc-debug-notes/20260424150030.png)
>
> 设置完 shutdown 状态后，通过 `return` 退出 `_loop` 函数，结束线程。

> **📝 Prompt 3 — Plan Approval 拒绝流程**
> bob 向 lead 发起 plan 请求：
> ![](/images/cc-debug-notes/20260424150643.png)
>
...
> ```
> ![](/images/cc-debug-notes/20260424150859.png)
...
> ```
>
> ![](/images/cc-debug-notes/20260424154620.png)
> ![](/images/cc-debug-notes/20260424154743.png)
> ![](/images/cc-debug-notes/20260424154810.png)
>
...
> ![](/images/cc-debug-notes/20260424160830.png)
> ![](/images/cc-debug-notes/20260424160640.png)
...
>
> ![](/images/cc-debug-notes/20260424165830.png)
> ![](/images/cc-debug-notes/20260424165928.png)
> ![](/images/cc-debug-notes/20260424170032.png)
